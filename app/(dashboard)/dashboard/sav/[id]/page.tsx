      ...
      {!isClosed ? (
        ...
        <div className="border rounded-lg p-6 bg-slate-50">
          <div className="flex items-center gap-3 text-slate-600">
            ...
            <div>
              <p className="font-medium">Ce ticket est fermé</p>
              <p className="text-sm text-slate-500">
                {ticket.status === "RESOLVED" && "Le problème a été résolu."}
                {ticket.status === "CLOSED" && "Ce ticket a été clôturé."}
                {ticket.status === "CANCELLED" && "Ce ticket a été annulé."}
          ...
          <div className="mt-4">
            <Button asChild variant="outline">
              <Link href="/dashboard/sav/nouveau">Créer un nouveau ticket</Link>
            </Button>
          </div>
        </div>
      )}
