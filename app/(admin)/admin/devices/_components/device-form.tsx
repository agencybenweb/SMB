                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-lg border border-slate-200 dark:border-slate-800 space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                name="imageUrl"
                                value={previewImage.startsWith("blob:") ? "" : previewImage} // Don't bind blob url to hidden inputs usually, but here we bind to visible input. If blob, we clear text input to indicate file upload will take precedence? No, better to show nothing or let user type. 
                                // Actually, if user uploads file, imageUrl input is ignored by server action logic priority, but good UX to clear it or show "Fichier local sélectionné"
